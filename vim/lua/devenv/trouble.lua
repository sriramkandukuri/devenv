...
--VH |Space + x + x|show navigation pane for diags qlist loclist|
nnoremap("<leader>xx", "<cmd>Trouble<cr>")
--VH |Space + x + w|show diagnostics of workspace|
nnoremap("<leader>xw", "<cmd>Trouble workspace_diagnostics<cr>")
--VH |Space + x + d|show document diagnostics|
nnoremap("<leader>xd", "<cmd>Trouble document_diagnostics<cr>")
--VH |Space + x + l|show beutified loclist|
nnoremap("<leader>xl", "<cmd>Trouble loclist<cr>")
--VH |Space + x + l|show beutified quickfix list|
nnoremap("<leader>xq", "<cmd>Trouble quickfix<cr>")
--VH |Space + x + l|show lsp references|
